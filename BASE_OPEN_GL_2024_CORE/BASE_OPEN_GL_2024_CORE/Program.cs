...
partial class Program
{
    ...
    static FG.TCALLBACKglutSpecialUpProc F_Gestion_Touches_Speciales_Relachee;
    ...
    static void Main()
    {
        ...
        F_Gestion_Touches_Speciales_Relachee = delegate (int P_Touche, int P_X, int P_Y) { Gestion_Touches_Speciales_Relachees(P_Touche, P_X, P_Y); };
        ...
        FG.SpecialUpFunc(F_Gestion_Touches_Speciales_Relachee);
